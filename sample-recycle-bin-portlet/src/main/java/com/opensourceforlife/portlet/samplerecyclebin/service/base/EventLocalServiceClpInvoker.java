...
public class EventLocalServiceClpInvoker {
    ...
    public EventLocalServiceClpInvoker() {
        ...
        _methodParameterTypes0 = new String[] {
                "com.opensourceforlife.portlet.samplerecyclebin.model.Event"
            };
        ...
        _methodParameterTypes60 = new String[] { "long", "int", "int", "int" };

        _methodName61 = "getEventsCountByGroupId";

        _methodParameterTypes61 = new String[] { "long" };

        _methodName62 = "getEventsCountByGroupId";

        _methodParameterTypes62 = new String[] { "long", "int" };

        _methodName63 = "moveEntryToTrash";

        _methodParameterTypes63 = new String[] { "long", "long" };

        _methodName64 = "restoreEntryFromTrash";
        ...
        _methodParameterTypes66 = new String[] { "long", "int", "long" };
    }
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return EventLocalServiceUtil.addEvent((com.opensourceforlife.portlet.samplerecyclebin.model.Event) arguments[0]);
        }
        ...
        if (_methodName3.equals(name) &&
            ...
            return EventLocalServiceUtil.deleteEvent((com.opensourceforlife.portlet.samplerecyclebin.model.Event) arguments[0]);
        }
        ...
        if (_methodName19.equals(name) &&
            ...
            return EventLocalServiceUtil.updateEvent((com.opensourceforlife.portlet.samplerecyclebin.model.Event) arguments[0]);
        }
        ...
        if (_methodName51.equals(name) &&
            ...
            EventLocalServiceUtil.addEventResources((com.opensourceforlife.portlet.samplerecyclebin.model.Event) arguments[0],
        ...
        if (_methodName63.equals(name) &&
            ...
            return EventLocalServiceUtil.moveEntryToTrash(((Long) arguments[0]).longValue(),
                ((Long) arguments[1]).longValue());
        }

        if (_methodName64.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes64, parameterTypes)) {
            EventLocalServiceUtil.restoreEntryFromTrash(((Long) arguments[0]).longValue(),
                ((Long) arguments[1]).longValue());
        ...
        if (_methodName66.equals(name) &&
            ...
            return EventLocalServiceUtil.updateStatus(((Long) arguments[0]).longValue(),
                ((Integer) arguments[1]).intValue(),
