...
import com.opensourceforlife.portlet.samplerecyclebin.model.EventClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "sample-recycle-bin-portlet-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "sample-recycle-bin-portlet";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "com.opensourceforlife.portlet.samplerecyclebin.model.impl.EventImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals(
            ...
            return new com.opensourceforlife.portlet.samplerecyclebin.NoSuchEventException();
        }
